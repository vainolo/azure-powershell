...
## SYNOPSIS
Sets the auditing settings for an Azure SQL database.
...
```
PS C:\>Set-AzSqlDatabaseAuditing -State Enabled -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01" -LogAnalytics -WorkspaceId "WorkspaceId"
```
